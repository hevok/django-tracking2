...
from track.models import Visitor, Pageview
from track.settings import TRACK_PAGEVIEWS
...
@permission_required('track.view_visitor')
def stats(request):
    ...
    # If the start_date is later than when track began, no reason
