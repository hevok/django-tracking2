...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracking_pageview', (
            ...
            ('visitor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pageviews', to=orm['track.Visitor'])),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('view_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('track', ['Pageview'])
    ...
    models = {
        ...
        'track.pageview': {
            ...
            'visitor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pageviews'", 'to': "orm['track.Visitor']"})
        },
        'track.visitor': {
